	...
	render() {
		...
		return (
			<div id="order-paid" className="col-xs-12 text-center">
				...
				<a href={`${config.API_BASE_URL}/orders/${this.props.order.unique_reference}`} target="_blank"><h4 style={{margin: "25px 0 0", "fontWeight": "500"}}>See your order details on our API</h4></a>

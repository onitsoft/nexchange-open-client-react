            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <p>
                    Our VAT number - GB233 5420 37.<br />Our registered office address - Suite 11, Penhurst House, 352-254 Battersea Park
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <p>
                    Missing your favorite coin? Let us know here: <a href="mailto:support@nexchange.io">support@nexchange.io</a>.
                  </p>
                </div>
              }
            />
                ...
                <div>
                  ...
                  <ol>
                    <li>
                      ...
                      <b>want to spend</b>, and the currency type you <b>want to buy</b> (e.g. if you want to spend 1 BTC to buy ETH at the
                      exchange rate shown, you enter “1” and click on “GET STARTED”)
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <p>
                    Once you have sent the cryptocurrency, losing connection, closing the tab or navigating elsewhere will not impact the
                    transaction.
                  </p>
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <ol>
                    <li>
                      We pay half of our revenues to the affiliates. One fourth of revenues for 2nd degree affiliates and one eighth of
                    ...
                    <li>
                      ...
                      typically 10 times the minimal order amount (no tx fee), but it can be adjusted downward, in which case, you would
                      need to cover the tx fee yourself.
                    </li>
                    <li>You will be receiving your funds to the withdraw address specified on this order.</li>
                    <li>
                      If you would like to change withdrawal address or preferred currency, let us know in support, and we will take care of
                      it.
                    </li>
                  </ol>
              ...
              answer={
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      Ethereum (ETH): <a href="https://github.com/ethereum/mist/releases">https://github.com/ethereum/mist/releases</a>
                    </li>
                    <li>

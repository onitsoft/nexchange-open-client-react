...
class OrderInitial extends Component {
  ...
  getAddressIdType() {
    if (this.props.order.deposit_address) {
      return this.props.order.deposit_address.payment_id
        ? { label: 'Payment Id', key: 'payment_id' }
        : this.props.order.deposit_address.destination_tag
        ? { label: 'Destination Tag', key: 'destination_tag' }
        : this.props.order.deposit_address.memo
        ? { label: 'Memo', key: 'memo' }
        : null;
    }
  }
        ...
        {t => (
          <div className={styles.container}>
            ...
            <div className={styles.details}>
              {!this.props.isLimitOrder && this.props.time !== '00:00' ? (
                <h3>
                  {t('order.initial1')}:{' '}

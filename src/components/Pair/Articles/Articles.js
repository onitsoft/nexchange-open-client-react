...
import GraphCMSProvider from 'Src/services/graphcms';
...
export const Articles = ({ data, ...props }) => {
  ...
  const articles = useMemo(() => [...((quote && quote.articles) || []), ...((base && base.articles) || [])], [base, quote]);
...
export default <GraphCMSProvider>{graphql(GET_ARTILCES_QUERY)(Articles)}</GraphCMSProvider>;

        ...
        <BreakpointProvider queries={defaultQuery}>
          <BrowserRouter>
            <Suspense fallback={<></>}>
              <ToTop>
                <Referrals />
                <Header showSupportModal={showSupportModal} hideSupport={hideSupport} setShowSupportModal={setShowSupportModal} />
                ...
                <Footer showSupportModal={showSupportModal} hideSupport={hideSupport} setShowSupportModal={setShowSupportModal} />
                <Intercom />
              </ToTop>
            </Suspense>
          </BrowserRouter>

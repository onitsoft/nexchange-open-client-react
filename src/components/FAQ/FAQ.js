                      ...
                      <QuestionAnswer
                        ...
                        answer={
                          <Trans i18nKey="faq.ans3">
                            <p>
                              Our service fee is 0.5%. There are no hidden fees here: the amount you see on the screen is the exact amount
                            ...
                            <Trans i18nKey="faq.ans5">
                              ...
                              <ol>
                                <li>
                                  ...
                                  ETH at the exchange rate shown, you enter “1” and click on “CONFIRM and PLACE ORDER”)
                        ...
                        answer={
                          <div>
                            <Trans i18nKey="faq.ans9">
                              <p>
                                We do not provide wallet hosting service at the moment. The exchange happens between two of your wallets:
                              </p>
                              <ol>
                                <li>
                        ...
                        answer={
                          <div>
                            <Trans i18nKey="faq.ans11">
                              ...
                              <ol>
                                <li>
                                  We pay half of our revenues to the affiliates. One fourth of revenues for 2nd degree affiliates and one
                                  eighth of revenues for 3rd degree affiliates.
                                </li>
                                <li>
                                  We send referral payouts once the funds accumulated on your account reach the threshold. The threshold
                                  amount is typically 10 times the minimal order amount (no tx fee), but it can be adjusted downward, in
                                  which case, you would need to cover the tx fee yourself.
                                </li>
                                <li>You will be receiving your funds to the withdraw address specified on this order.</li>
                                <li>
                                  If you would like to change withdrawal address or preferred currency, let us know in support, and we will
                                  take care of it.
                                </li>
                              </ol>
                        ...
                        answer={
                          <div>
                            <Trans i18nKey="faq.ans14">
                              ...
                              <p>
                                Please note that we are not affiliated with the websites mentioned above, these links are for user’s
                                reference purposes only. We will not accept any liability, obligation or responsibility whatsoever for the

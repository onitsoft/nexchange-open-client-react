...
class Transitioning extends Component {
  ...
  redirect() {
    ...
    if (orderRef) {
      document.location.href = `https://n.exchange/en/order/${orderRef}`;
    }
  }
            ...
            <div className="container">
              <div className={`col-xs-12 ${styles.transitioning}`}>
                <div className={`col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 ${styles.content}`}>
                  ...
                  <p>
                    You are now transitioning from <strong>DRAGONDEX</strong> to <strong>N.EXCHANGE</strong>&nbsp; to make a FIAT to
                  ...
                  <p class={styles.small}>
                    Australian Dollars, US Dollars, Euro - <strong>Accepted</strong>
                  </p>
                  <p class={styles.smaller}>
                    Please read n.exchange&nbsp;
                    <a href="https://n.exchange/terms-and-conditions/" target="_blank">
                      Privacy Policy
                    </a>
                    &nbsp;and&nbsp;
                    <a href="https://n.exchange/privacy" target="_blank">
                      Terms and Conditions
                    </a>
                  </p>
                  <div onClick={() => this.redirect()} class={styles.button}>
                    CLICK TO PROCEED
                  </div>
                </div>
              </div>

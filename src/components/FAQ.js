            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <p>
                    Our VAT number - GB233 5420 37.<br />Our registered office
                    address - Suite 11, Penhurst House, 352-254 Battersea Park
                    Road, London, England, SW11 3BY.
                  </p>
                  <p>
                    Our customer support phone number in UK is{' '}
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <p>
                    We will be adding more currencies very soon, stay tuned!
                  </p>
                  <p>
                    Missing your favorite coin? Let us know here:{' '}
                    <a href="mailto:support@nexchange.io">
            ...
            <QuestionAnswer
              ...
              answer={
                <p>
                  ...
                  before you receive your coins in your desired currency. The
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <ol>
                    <li>
                      <b>Enter</b> your desired <b>amount, choose</b> the
                      currency type you <b>want to spend</b>, and the currency
                      type you <b>want to buy</b> (e.g. if you want to spend 1
                      BTC to buy ETH at the exchange rate shown, you enter “1”
                      and click on “GET STARTED”)
                      <img
                        src="/img/faq/step1.png"
                        alt="How does it work, step 1"
                      />
                    </li>
                    <li>
                      <b>Enter your destination address</b> (e.g. if you are
                      buying ETH, you enter your ETH wallet address)
                      <img
                        src="/img/faq/step2.png"
                        alt="How does it work, step 2"
                      />
                    </li>
                    <li>
                      ...
                      <img
                        ...
                        alt="How does it work, step 3"
                      />
                    </li>
                    <li>
                      Once we receive your coins, the processing of your order
                      will start immediately.
                    </li>
                    <li>
                      Once everything is done, you will receive your ETH.
                      Hurray! You just successfully exchanged your
                      cryptocurrency.
                    </li>
                  </ol>
                  <p>
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <ol>
                    <li>
                      The wallet you send the funds from (<b>spending</b>{' '}
                      wallet)
                    </li>
                    <li>
              ...
              answer={
                <div>
                  ...
                  <img
                    src="/img/faq/faq.png"
                    style={{ margin: '10px 0' }}
                    alt="Order ID example"
                  />
                  <p>
                    Make sure you record your order id. We recommend bookmarking
                    the page, you can always navigate to it later.
                  </p>
                  <p>
                    Once you have sent the cryptocurrency, losing connection,
                    closing the tab or navigating elsewhere will not impact the
                    transaction.
                  </p>
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  ...
                  <ol>
                    <li>
                      We pay half of our revenues to the affiliates. One fourth
                      of revenues for 2nd degree affiliates and one eighth of
                      revenues for 3rd degree affiliates.
                    </li>
                    <li>
                    ...
                    <li>
                      You will be receiving your funds to the withdraw address
                      specified on this order.
                    </li>
                    <li>
                      If you would like to change withdrawal address or
                      preferred currency, let us know in support, and we will
                      take care of it.
                    </li>
                  </ol>
              ...
              answer={
                <div>
                  <p>
                    ...
                    the blockchain. During this time interval, we effectively
                    freeze the price for your order.
                  </p>
                  <p>
                    If the 15 minute time window closes, the order is canceled
                    because the price will have expired and will need to be
                    recalculated.
                  </p>
                  <p>
                    If you did not send your funds in time, simply initiate a
                    new order.
                  </p>
                  <p>
                    If you did send your funds, but for some reason they were
              ...
              answer={
                <div>
                  <p>
                    ...
                    legitimate, real account with over 500 followers and 100 SAT
                    for each like from an account of the same criteria.
                  </p>

                  <p>
                    <b>
                      We reserve the right to deny the bonus coins on any
                      grounds we see fit.
                    </b>
                  </p>
                </div>
              ...
              answer={
                <div>
                  <p>
                    ...
                    hold your coins, and thus you retain full control over your
                    assets at all times.
                  </p>
                  <p>
                    If you need some help obtaining a wallet for your desired
                    cryptocurrency, please look here:
                  </p>
                  <ul>
                    <li>
                      Bitcoin (BTC):{' '}
                  ...
                  <p>
                    Please note that we are not affiliated with the websites
                    mentioned above, these links are for user’s reference
                    purposes only. We will not accept any liability, obligation

    ...
    <div className="container">
      ...
      <div className="row">
        <Testimonial
          ...
          text="Check Out @NexchangeIO with a Simple, Secure and a transparent
						exchange that you use without registration."
        ...
        <Testimonial
          ...
          text="N.exchange is the next big exchange… clean ui, mobile friendly,
						smooth transaction and transparent platform. I have tried different types
						exchanges but this platform delivers what I want…"
        ...
        <Testimonial
          ...
          text="I traded $24,000 worth of BTC to LTC yesterday, great trustworthy exchange.
						Had a few hiccups but  everything was sorted out. Would use again. 😊"

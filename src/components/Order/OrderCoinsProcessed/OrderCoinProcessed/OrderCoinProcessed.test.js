...
describe('OrderCoinProcessed', () => {
  beforeEach(() => {
    ...
    axiosMock.onGet(`https://api.n.exchange/en/api/v1/get_price/${pairOrder}/`).reply(200, mockDataOrder);
    ...
    axiosMock.onGet(`https://api.n.exchange/en/api/v1/get_price/${pairOrderFiat}/`).reply(200, mockDataOrderFiat);
  });

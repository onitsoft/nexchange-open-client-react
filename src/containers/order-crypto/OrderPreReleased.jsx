...
const OrderPreReleased = (props) => (
	<div className="col-xs-12 text-center order-status-section">
		...
		<a href={`${config.API_BASE_URL}/orders/${props.order.unique_reference}`} target="_blank"><h4 style={{margin: "25px 0 0px", "fontWeight": "500"}}>See your order details on our API</h4></a>
	</div>
);

          ...
          <Fragment>
            ...
            <div className={`col-xs-12 ${styles.faqs}`}>
              ...
              : <div id='faq.list' className={styles.list}>
                ...
                answer={
                  <Trans i18nKey="whitelabelfaq.ans1">
                    <div>
                      <p>
              ...
              {this.showQuestion(2) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans2">
                      <p>
              ...
              {this.showQuestion(3) ?
                ...
                openSupportModal={this.openSupportModal}
                answer={
                  <Trans i18nKey="whitelabelfaq.ans3">
                    <p>
              ...
              {this.showQuestion(4) ?
                ...
                openSupportModal={this.openSupportModal}
                answer={
                  <Trans i18nKey="whitelabelfaq.ans4">
                    <p>
              ...
              {this.showQuestion(5) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans5">
              ...
              {this.showQuestion(6) ?
                ...
                openSupportModal={this.openSupportModal}
                answer={
                  <Trans i18nKey="whitelabelfaq.ans6">
                    <p>
              ...
              {this.showQuestion(8) ?
                ...
                openSupportModal={this.openSupportModal}
                answer={
                  <Trans i18nKey="whitelabelfaq.ans8">
              ...
              {this.showQuestion(9) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans9">
              ...
              {this.showQuestion(10) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans10">
              ...
              {this.showQuestion(11) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans11">
              ...
              {this.showQuestion(12) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans12">
                      <p>
              ...
              {this.showQuestion(13) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans13">
                      <p>
              ...
              {this.showQuestion(14) ?
                ...
                answer={
                  <div>
                    <Trans i18nKey="whitelabelfaq.ans14">
                      <p>

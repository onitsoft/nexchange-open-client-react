        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navigation-index">
            <ul className="nav navbar-nav navbar-right">
              ...
              <li id="social-mobile">
                <a className="link btn btn-simple btn-just-icon visible-xs" href="/twitter" target="_blank">
                  <i className="fab fa-twitter" aria-hidden="true" />
                </a>

                <a className="link btn btn-simple btn-just-icon visible-xs" href="/fb" target="_blank">
                  <i className="fab fa-facebook-f" aria-hidden="true" />
                </a>

                <a className="link btn btn-simple btn-just-icon visible-xs" href="/slack" target="_blank">
                  <i className="fab fa-slack-hash" aria-hidden="true" />
                </a>

                <a className="link btn btn-simple btn-just-icon visible-xs" href="/telegram" target="_blank">

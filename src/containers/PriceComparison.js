...
class PriceComparison extends Component {
  ...
  showBestRate(shapeshiftRate, changellyRate, nexchangeRate) {
    ...
    return (
      <img
        className={`${info[idx]}-logo`}
        src={`/img/prices/${info[idx]}.png`}
        alt={`${info[idx]}`}
      />
    );
  }
          ...
          this.setState(
            {
              nexchange: {
                ...
                dogebtc: (1 / parseFloat(dogebtc.data[0].ticker.ask)).toFixed(
                  1
                ),
                ethltc: (1 / parseFloat(ethltc.data[0].ticker.ask)).toFixed(2),
                dogeeth: (1 / parseFloat(dogeeth.data[0].ticker.ask)).toFixed(
                  1
                ),
                dogeltc: (1 / parseFloat(dogeltc.data[0].ticker.ask)).toFixed(
                  1
                ),
              },
            },
    ...
    axios({
      ...
      .then(response => {
        this.setState(
          {
            changelly: {
              btceth: (parseFloat(response.data['ETH']['BTC']) * 0.98).toFixed(
                4
              ),
              btcltc: (parseFloat(response.data['LTC']['BTC']) * 0.98).toFixed(
                4
              ),
              dogebtc: (
                parseFloat(response.data['BTC']['DOGE']) * 0.98
              ).toFixed(1),
              ethltc: (parseFloat(response.data['LTC']['ETH']) * 0.98).toFixed(
                4
              ),
              dogeeth: (
                parseFloat(response.data['ETH']['DOGE']) * 0.98
              ).toFixed(1),
              dogeltc: (
                parseFloat(response.data['LTC']['DOGE']) * 0.98
              ).toFixed(1),
            },
          },
          () => {
                ...
                <table className="table">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <img
                          className="nexchange-logo"
                          src="/img/prices/nexchange2.png"
                          alt="N.exchange"
                        />
                      </th>
                      <th>
                        <img
                          src="/img/prices/shapeshift.png"
                          alt="Shapeshift"
                        />
                      </th>
                      <th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.btceth} BTC{' '}
                        {this.priceDiff(
                          this.state.nexchange.btceth,
                          this.state.shapeshift.btceth
                        )}
                      </td>
                      <td>
                        {this.state.changelly.btceth} BTC{' '}
                        {this.priceDiff(
                          this.state.nexchange.btceth,
                          this.state.changelly.btceth
                        )}
                      </td>
                      <td>
                        {this.showBestRate(
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.dogeeth} DOGE{' '}
                        {this.priceDiff(
                          this.state.nexchange.dogeeth,
                          this.state.shapeshift.dogeeth
                        )}
                      </td>
                      <td>
                        {this.state.changelly.dogeeth} DOGE{' '}
                        {this.priceDiff(
                          this.state.nexchange.dogeeth,
                          this.state.changelly.dogeeth
                        )}
                      </td>
                      <td>
                        {this.showBestRate(
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.btcltc} BTC{' '}
                        {this.priceDiff(
                          this.state.nexchange.btcltc,
                          this.state.shapeshift.btcltc
                        )}
                      </td>
                      <td>
                        {this.state.changelly.btcltc} BTC{' '}
                        {this.priceDiff(
                          this.state.nexchange.btcltc,
                          this.state.changelly.btcltc
                        )}
                      </td>
                      <td>
                        {this.showBestRate(
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.ethltc} ETH{' '}
                        {this.priceDiff(
                          this.state.nexchange.ethltc,
                          this.state.shapeshift.ethltc
                        )}
                      </td>
                      <td>
                        {this.state.changelly.ethltc} ETH{' '}
                        {this.priceDiff(
                          this.state.nexchange.ethltc,
                          this.state.changelly.ethltc
                        )}
                      </td>
                      <td>
                        {this.showBestRate(
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.dogeltc} DOGE{' '}
                        {this.priceDiff(
                          this.state.nexchange.dogeltc,
                          this.state.shapeshift.dogeltc
                        )}
                      </td>
                      <td>
                        {this.state.changelly.dogeltc} DOGE{' '}
                        {this.priceDiff(
                          this.state.nexchange.dogeltc,
                          this.state.changelly.dogeltc
                        )}
                      </td>
                      <td>
                        {this.showBestRate(
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.shapeshift.dogebtc} DOGE{' '}
                        {this.priceDiff(
                          this.state.nexchange.dogebtc,
                          this.state.shapeshift.dogebtc
                        )}
                      </td>
                      <td>
                        {this.state.changelly.dogebtc} DOGE{' '}
                        {this.priceDiff(
                          this.state.nexchange.dogebtc,
                          this.state.changelly.dogebtc
                        )}
                      </td>
                      <td>
                        {this.showBestRate(

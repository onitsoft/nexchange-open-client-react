                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {this.state.changelly.btceth} BTC {this.priceDiff(this.state.nexchange.btceth, this.state.changelly.btceth)}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.changelly.dogeeth} DOGE {this.priceDiff(this.state.nexchange.dogeeth, this.state.changelly.dogeeth)}
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.changelly.btcltc} BTC {this.priceDiff(this.state.nexchange.btcltc, this.state.changelly.btcltc)}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.changelly.ethltc} ETH {this.priceDiff(this.state.nexchange.ethltc, this.state.changelly.ethltc)}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.changelly.dogeltc} DOGE {this.priceDiff(this.state.nexchange.dogeltc, this.state.changelly.dogeltc)}
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.state.changelly.dogebtc} DOGE {this.priceDiff(this.state.nexchange.dogebtc, this.state.changelly.dogebtc)}
                      </td>
                      <td>

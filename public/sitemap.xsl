  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/tachyons@4.6.1/css/tachyons.min.css" />
      </head>
      <body class="ph3 pb3 mid-gray">
        <header class="mw8 pv4 center">
          ...
          <p>
            This is an XML sitemap, meant for consumption by search engines.<br /> You can find more information about XML sitemaps on
            <a href="https://sitemaps.org" class="link blue">sitemaps.org</a>.
          </p>
        </header>
